...
app=Flask(__name__,template_folder=r'c:\Users\anude\Desktop\RecipeApp\templates')

#Replace with your Spoonacular API key
API_KEY='8d3ac956e5f1401d95ebf8b45455de7a'
...
def index():
    ...
    #Perform a search for recippes with the decode search query
    recipes=search_recipes(decoded_search_query)
    #Render the main page
    return render_template('index.html',recipes=recipes,search_query=decoded_search_query)
    
#Function to search for recipes based on the provide query 
def search_recipes(query):
    ...
    if response.status_code == 200:
        ...
        data=response.json()
        #Return the list of recipes results
        return data['results']
